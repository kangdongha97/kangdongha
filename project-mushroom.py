...
ishape=48 # 224  48
train_digits_loader = train_datagen.flow_from_directory('data1/train', target_size=(ishape, ishape),
        batch_size=5, color_mode = 'rgb',  class_mode='categorical')

test_digits_loader = test_datagen.flow_from_directory( 'data1/test', target_size=(ishape, ishape),
...
for i in range(num_images):
  ...
  img_path = 'data1/train/'+train_digits_loader.filenames[i]
